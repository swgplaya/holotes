...
TRANSLATIONS: dict[str, dict[str, str]] = {'ru': {'language.selector': 'Язык интерфейса',
        ...
        'settings.telegram.placeholder': 'Настройки Telegram-бота будут добавлены на следующем этапе.',
 ...
 'en': {'language.selector': 'Interface language',
        ...
        'settings.telegram.placeholder': 'Telegram bot settings will be added during the next development stage.',
 ...
 'zh-CN': {'language.selector': '界面语言',
           ...
           'tabs.import': '导入银行流水',
            ...
            'settings.telegram.placeholder': 'Telegram 机器人设置将在下一开发阶段添加。',
