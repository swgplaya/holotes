...
TRANSLATIONS: dict[str, dict[str, str]] = {'ru': {'language.selector': 'Язык интерфейса',
        ...
        'rules.fields.amount_operator': 'Ограничение по сумме',
        'rules.fields.amount_value': 'Сумма, ₽',
        'rules.fields.amount_value_lower': 'Нижняя граница, ₽',
        'rules.fields.amount_value_to': 'Верхняя граница, ₽',
        'rules.placeholders.amount_value': 'Например: 1000,50',
        'rules.placeholders.amount_value_to': 'Например: 5000',
        'rules.help.amount': 'Диапазон включает нижнюю и верхнюю границы.',
        ...
        'rules.errors.amount_required': 'Укажите сумму для денежного условия.',
        'rules.errors.amount_invalid': 'Введите корректную сумму с точностью не более '
                                       'двух знаков после запятой.',
        'rules.errors.amount_to_required': 'Укажите верхнюю границу суммы.',
        'rules.errors.amount_to_invalid': 'Введите корректную верхнюю границу с '
                                          'точностью не более двух знаков после запятой.',
        'rules.errors.amount_range_order': 'Верхняя граница суммы не может быть меньше '
                                           'нижней.',
        ...
        'rules.options.amount.any': 'Без ограничения',
        'rules.options.amount.gt': 'Больше (>)',
        'rules.options.amount.gte': 'Больше или равно (>=)',
        'rules.options.amount.lt': 'Меньше (<)',
        'rules.options.amount.lte': 'Меньше или равно (<=)',
        'rules.options.amount.eq': 'Равно (=)',
        'rules.options.amount.between': 'Между',
        ...
        'rules.saved.columns.amount': 'Сумма',
        'rules.saved.amount.between': 'От {lower} до {upper}',
        ...
        'reports.period.mode': 'Тип периода',
        'reports.period.mode.month': 'Месяц',
        'reports.period.mode.year': 'Год',
        'reports.period.mode.last_30_days': 'Последние 30 дней',
        'reports.period.mode.all_time': 'Всё время',
        'reports.period.mode.custom': 'Произвольный период',
        'reports.period.month': 'Месяц',
        'reports.period.year': 'Год',
        'reports.period.range': 'Диапазон',
 ...
 'en': {'language.selector': 'Interface language',
        ...
        'rules.fields.amount_operator': 'Amount condition',
        'rules.fields.amount_value': 'Amount, ₽',
        'rules.fields.amount_value_lower': 'Lower bound, ₽',
        'rules.fields.amount_value_to': 'Upper bound, ₽',
        'rules.placeholders.amount_value': 'For example: 1000.50',
        'rules.placeholders.amount_value_to': 'For example: 5000',
        'rules.help.amount': 'The range includes both the lower and upper bounds.',
        ...
        'rules.errors.amount_required': 'Enter an amount for the amount condition.',
        'rules.errors.amount_invalid': 'Enter a valid amount with no more than two '
                                       'decimal places.',
        'rules.errors.amount_to_required': 'Enter the upper amount bound.',
        'rules.errors.amount_to_invalid': 'Enter a valid upper bound with no more than '
                                          'two decimal places.',
        'rules.errors.amount_range_order': 'The upper amount bound cannot be lower than '
                                           'the lower bound.',
        ...
        'rules.options.amount.any': 'No limit',
        'rules.options.amount.gt': 'Greater than (>)',
        'rules.options.amount.gte': 'Greater than or equal (>=)',
        'rules.options.amount.lt': 'Less than (<)',
        'rules.options.amount.lte': 'Less than or equal (<=)',
        'rules.options.amount.eq': 'Equal to (=)',
        'rules.options.amount.between': 'Between',
        ...
        'rules.saved.columns.amount': 'Amount',
        'rules.saved.amount.between': 'From {lower} to {upper}',
        ...
        'reports.period.mode.month': 'Month',
        'reports.period.mode.year': 'Year',
        'reports.period.mode.last_30_days': 'Last 30 days',
        'reports.period.mode.all_time': 'All time',
        'reports.period.mode.custom': 'Custom period',
 ...
 'zh-CN': {'language.selector': '界面语言',
        ...
        'classification.pagination.position': '第 {page}/{pages} 页 · 显示第 {start}–{end} 笔，共 {total} 笔',
           ...
           'rules.fields.amount_operator': '金额限制',
           'rules.fields.amount_value': '金额，₽',
           'rules.fields.amount_value_lower': '下限，₽',
           'rules.fields.amount_value_to': '上限，₽',
           'rules.placeholders.amount_value': '例如：1000.50',
           'rules.placeholders.amount_value_to': '例如：5000',
           'rules.help.amount': '区间包含下限和上限。',
           ...
           'rules.errors.amount_required': '请输入金额条件的金额。',
           'rules.errors.amount_invalid': '请输入有效金额，最多保留两位小数。',
           'rules.errors.amount_to_required': '请输入金额上限。',
           'rules.errors.amount_to_invalid': '请输入有效的金额上限，最多保留两位小数。',
           'rules.errors.amount_range_order': '金额上限不能小于下限。',
           ...
           'rules.options.amount.any': '无限制',
           'rules.options.amount.gt': '大于 (>)',
           'rules.options.amount.gte': '大于或等于 (>=)',
           'rules.options.amount.lt': '小于 (<)',
           'rules.options.amount.lte': '小于或等于 (<=)',
           'rules.options.amount.eq': '等于 (=)',
           'rules.options.amount.between': '区间',
           ...
           'rules.saved.columns.amount': '金额',
           'rules.saved.amount.between': '{lower} 至 {upper}',
           ...
           'reports.period.mode': '期间类型',
           'reports.period.mode.month': '月份',
           'reports.period.mode.year': '年份',
           'reports.period.mode.last_30_days': '最近 30 天',
           'reports.period.mode.all_time': '全部期间',
           'reports.period.mode.custom': '自定义期间',
           'reports.period.month': '月份',
           'reports.period.year': '年份',
           'reports.period.range': '日期范围',
