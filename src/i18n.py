...
TRANSLATIONS: dict[str, dict[str, str]] = {'ru': {'language.selector': 'Язык интерфейса',
        ...
        'settings.caption': 'Локальные параметры Open MAS, резервные копии и интеграции.',
        ...
        'settings.database.restore.warning': 'Текущая база будет заменена. Перед заменой Open MAS автоматически создаст страховочную резервную копию.',
        ...
        'settings.telegram.caption': 'Подключите собственного Telegram-бота к Open MAS.',
        ...
        'settings.telegram.delete.warning': 'После удаления Open MAS не сможет запустить Telegram-бота, пока не будет сохранён новый токен.',
 ...
 'en': {'language.selector': 'Interface language',
        ...
        'settings.caption': 'Local Open MAS settings, database backups, and integrations.',
        ...
        'settings.database.restore.warning': 'The active database will be replaced. Open MAS will create a safety backup before replacement.',
        ...
        'settings.telegram.caption': 'Connect your own Telegram bot to Open MAS.',
        ...
        'settings.telegram.delete.warning': 'After deletion, Open MAS cannot start the Telegram bot until a new token is saved.',
 ...
 'zh-CN': {'language.selector': '界面语言',
           ...
           'tabs.import': '导入银行流水',
            'tabs.settings': '设置',
            'settings.title': '设置',
            'settings.caption': 'Open MAS 本地设置、数据库备份和集成。',
            ...
            'settings.database.restore.warning': '当前数据库将被替换。替换前，Open MAS 会自动创建安全备份。',
            ...
            'settings.telegram.caption': '将您自己的 Telegram 机器人连接到 Open MAS。',
            ...
            'settings.telegram.delete.warning': '删除后，在保存新 token 之前，Open MAS 无法启动 Telegram 机器人。',
